...
Comparisons of SwinTransformer and ConvNext are are updated for fianl project. UPdate： New weight trained on resized 224\times224 cifar100 dataset can be found [here](https://pan.baidu.com/s/1BZh9xam0fhyrSt66R8YXtA), access code `9g30`.
